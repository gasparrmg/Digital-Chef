...
function videoControls(video, videoTimestamps) {
    ...
    $("#btn-next-step").click(function () {
        ...
        for (var i = 0; i < videoTimestamps.vegan.length - 1; i++) {
            if (video.currentTime >= videoTimestamps.vegan[i][0] && video.currentTime < videoTimestamps.vegan[i][1]) {
        ...
        for (var i = 0; i < videoTimestamps.meat.length - 1; i++) {
            if (video.currentTime >= videoTimestamps.meat[i][0] && video.currentTime < videoTimestamps.meat[i][1]) {
        ...
        for (var i = 0; i < videoTimestamps.desert.length - 1; i++) {
            if (video.currentTime >= videoTimestamps.desert[i][0] && video.currentTime < videoTimestamps.desert[i][1]) {
...
function stepHighlight(video, videoTimestamps) {
    $("#main-video").on("timeupdate", function () {
        ...
        if (video.currentTime >= videoTimestamps.vegan[0][0] && video.currentTime < videoTimestamps.vegan[0][1]) {
            $(".ingredients-bubble").fadeIn(500);
            $(".img-step.ingredients, .txt-step.ingredients").css("opacity", "1");
        } else {
            $(".ingredients-bubble").fadeOut(500);
        ...
        if (video.currentTime >= videoTimestamps.vegan[1][0] && video.currentTime < videoTimestamps.vegan[1][1]) {
            $(".img-step.two, .txt-step.two").css("opacity", "1");
        } else {
            $(".img-step.two, .txt-step.two").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.vegan[2][0] && video.currentTime < videoTimestamps.vegan[2][1]) {
            $(".img-step.three, .txt-step.three").css("opacity", "1");
        } else {
            $(".img-step.three, .txt-step.three").css("opacity", "0.3");   
        }
        if (video.currentTime >= videoTimestamps.vegan[3][0] && video.currentTime < videoTimestamps.vegan[3][1]) {
            $(".img-step.four, .txt-step.four").css("opacity", "1");
        } else {
            $(".img-step.four, .txt-step.four").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.vegan[4][0] && video.currentTime < videoTimestamps.vegan[4][1]) {
            $(".img-step.five, .txt-step.five").css("opacity", "1");
            $("#image-gallery-wrapper").animate({ scrollTop: "300px" });
        } else {
            $(".img-step.five, .txt-step.five").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.vegan[5][0] && video.currentTime < videoTimestamps.vegan[5][1]) {
            $(".img-step.six, .txt-step.six").css("opacity", "1");
        } else {
            $(".img-step.six, .txt-step.six").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.vegan[6][0] && video.currentTime < videoTimestamps.vegan[6][1]) {
            $(".img-step.seven, .txt-step.seven").css("opacity", "1");
            $("#image-gallery-wrapper").animate({ scrollTop: "300px" });
        } else {
            $(".img-step.seven, .txt-step.seven").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.vegan[7][0] && video.currentTime < videoTimestamps.vegan[7][1]) {
            $(".img-step.eight, .txt-step.eight").css("opacity", "1");
        } else {
            $(".img-step.eight, .txt-step.eight").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.vegan[8][0] && video.currentTime < videoTimestamps.vegan[8][1]) {
            $(".img-step.nine, .txt-step.nine").css("opacity", "1");
            $("#image-gallery-wrapper").animate({ scrollTop: "300px" });
        } else {
            $(".img-step.nine, .txt-step.nine").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.vegan[9][0] && video.currentTime < videoTimestamps.vegan[9][1]) {
            $(".img-step.ten, .txt-step.ten").css("opacity", "1");
        } else {
            $(".img-step.ten, .txt-step.ten").css("opacity", "0.3");
        }

        if (video.currentTime >= videoTimestamps.vegan[10][0] && video.currentTime < videoTimestamps.vegan[10][1]) {
            $(".img-step.eleven, .txt-step.eleven").css("opacity", "1");
            $("#image-gallery-wrapper").animate({ scrollTop: "300px" });
        } else {
            $(".img-step.eleven, .txt-step.eleven").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.vegan[11][0] && video.currentTime < videoTimestamps.vegan[11][1]) {
            $(".img-step.twelve, .txt-step.twelve").css("opacity", "1");
        } else {
            $(".img-step.twelve, .txt-step.twelve").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.vegan[12][0] && video.currentTime < videoTimestamps.vegan[12][1]) {
        ...
        if (video.currentTime >= videoTimestamps.meat[0][0] && video.currentTime < videoTimestamps.meat[0][1]) {
            $(".ingredients-bubble").fadeIn(500);
            $(".img-step.ingredients, .txt-step.ingredients").css("opacity", "1");
        } else {
            $(".ingredients-bubble").fadeOut(500);
        ...
        if (video.currentTime >= videoTimestamps.meat[1][0] && video.currentTime < videoTimestamps.meat[1][1]) {
            $(".img-step.two, .txt-step.two").css("opacity", "1");
        } else {
            $(".img-step.two, .txt-step.two").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.meat[2][0] && video.currentTime < videoTimestamps.meat[2][1]) {
            $(".img-step.three, .txt-step.three").css("opacity", "1");
        } else {
            $(".img-step.three, .txt-step.three").css("opacity", "0.3");   
        }
        if (video.currentTime >= videoTimestamps.meat[3][0] && video.currentTime < videoTimestamps.meat[3][1]) {
            $(".img-step.four, .txt-step.four").css("opacity", "1");
        } else {
            $(".img-step.four, .txt-step.four").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.meat[4][0] && video.currentTime < videoTimestamps.meat[4][1]) {
            $(".img-step.five, .txt-step.five").css("opacity", "1");
            $("#image-gallery-wrapper").animate({ scrollTop: "300px" });
        } else {
            $(".img-step.five, .txt-step.five").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.meat[5][0] && video.currentTime < videoTimestamps.meat[5][1]) {
            $(".img-step.six, .txt-step.six").css("opacity", "1");
        } else {
            $(".img-step.six, .txt-step.six").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.meat[6][0] && video.currentTime < videoTimestamps.meat[6][1]) {
            $(".img-step.seven, .txt-step.seven").css("opacity", "1");
            $("#image-gallery-wrapper").animate({ scrollTop: "300px" });
        } else {
            $(".img-step.seven, .txt-step.seven").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.meat[7][0] && video.currentTime < videoTimestamps.meat[7][1]) {
            $(".img-step.eight, .txt-step.eight").css("opacity", "1");
        } else {
            $(".img-step.eight, .txt-step.eight").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.meat[8][0] && video.currentTime < videoTimestamps.meat[8][1]) {
            $(".img-step.nine, .txt-step.nine").css("opacity", "1");
            $("#image-gallery-wrapper").animate({ scrollTop: "300px" });
        } else {
            $(".img-step.nine, .txt-step.nine").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.meat[9][0] && video.currentTime < videoTimestamps.meat[9][1]) {
            $(".img-step.ten, .txt-step.ten").css("opacity", "1");
        } else {
            $(".img-step.ten, .txt-step.ten").css("opacity", "0.3");
        }

        if (video.currentTime >= videoTimestamps.meat[10][0] && video.currentTime < videoTimestamps.meat[10][1]) {
            $(".img-step.eleven, .txt-step.eleven").css("opacity", "1");
            $("#image-gallery-wrapper").animate({ scrollTop: "300px" });
        } else {
            $(".img-step.eleven, .txt-step.eleven").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.meat[11][0] && video.currentTime < videoTimestamps.meat[11][1]) {
            $(".img-step.twelve, .txt-step.twelve").css("opacity", "1");
        } else {
            $(".img-step.twelve, .txt-step.twelve").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.meat[12][0] && video.currentTime < videoTimestamps.meat[12][1]) {
            $(".img-step.thirteen, .txt-step.thirteen").css("opacity", "1");
            $("#image-gallery-wrapper").animate({ scrollTop: "300px" });
        } else {
            $(".img-step.thirteen, .txt-step.thirteen").css("opacity", "0.3");
        ...
        if (video.currentTime >= videoTimestamps.desert[0][0] && video.currentTime < videoTimestamps.desert[0][1]) {
            $(".ingredients-bubble").fadeIn(500);
            $(".img-step.ingredients, .txt-step.ingredients").css("opacity", "1");
        } else {
            $(".ingredients-bubble").fadeOut(500);
        ...
        if (video.currentTime >= videoTimestamps.desert[1][0] && video.currentTime < videoTimestamps.desert[1][1]) {
            $(".img-step.two, .txt-step.two").css("opacity", "1");
        } else {
            $(".img-step.two, .txt-step.two").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.desert[2][0] && video.currentTime < videoTimestamps.desert[2][1]) {
            $(".img-step.three, .txt-step.three").css("opacity", "1");
        } else {
            $(".img-step.three, .txt-step.three").css("opacity", "0.3");   
        }
        if (video.currentTime >= videoTimestamps.desert[3][0] && video.currentTime < videoTimestamps.desert[3][1]) {
            $(".img-step.four, .txt-step.four").css("opacity", "1");
        } else {
            $(".img-step.four, .txt-step.four").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.desert[4][0] && video.currentTime < videoTimestamps.desert[4][1]) {
            $(".img-step.five, .txt-step.five").css("opacity", "1");
            $("#image-gallery-wrapper").animate({ scrollTop: "300px" });
        } else {
            $(".img-step.five, .txt-step.five").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.desert[5][0] && video.currentTime < videoTimestamps.desert[5][1]) {
            $(".img-step.six, .txt-step.six").css("opacity", "1");
        } else {
            $(".img-step.six, .txt-step.six").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.desert[6][0] && video.currentTime < videoTimestamps.desert[6][1]) {
            $(".img-step.seven, .txt-step.seven").css("opacity", "1");
            $("#image-gallery-wrapper").animate({ scrollTop: "300px" });
        } else {
            $(".img-step.seven, .txt-step.seven").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.desert[7][0] && video.currentTime < videoTimestamps.desert[7][1]) {
            $(".img-step.eight, .txt-step.eight").css("opacity", "1");
        } else {
            $(".img-step.eight, .txt-step.eight").css("opacity", "0.3");
        }
        if (video.currentTime >= videoTimestamps.desert[8][0] && video.currentTime < videoTimestamps.desert[8][1]) {
            $(".img-step.nine, .txt-step.nine").css("opacity", "1");
            $("#image-gallery-wrapper").animate({ scrollTop: "300px" });
        } else {
            $(".img-step.nine, .txt-step.nine").css("opacity", "0.3");
